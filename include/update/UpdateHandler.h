...
//         if (mInfo)
//             return mInfo->mName.cstr();
//         else
//             return nullptr;
//     }

//     const char* getUpdateTag() {
//         if (mInfo)
//             return mInfo->mTagName.cstr();
//         else
//             return nullptr;
//     }

//     const char* getUpdateAuthor() {
//         if (mInfo)
//             return mInfo->mAuthorName.cstr();
//         else
//             return nullptr;
//     }
...
//         if (mInfo)
//             return mInfo->mPublishDate.cstr();
//         else
//             return nullptr;
//     }
