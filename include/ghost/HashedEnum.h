...
#define HASHED_ENUM(Name, ...)                                                                                                                       \
    namespace Name {                                                                                                                                 \
    enum Enum : s16 { Unknown = -1, __VA_ARGS__ __VA_OPT__(, ) End };                                                                                \
    static constexpr u16 ToValue(Enum type) {                                                                                                        \
        return static_cast<u16>(type);                                                                                                               \
    }                                                                                                                                                \
    static constexpr Enum ToEnum(u16 value) {                                                                                                        \
        return static_cast<Enum>(value);                                                                                                             \
    }                                                                                                                                                \
    static constexpr std::array<const char*, static_cast<u16>(Enum::End)> s_Strs{FOR_EACH(STRVALUE, __VA_ARGS__)};                                   \
