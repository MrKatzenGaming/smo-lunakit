...
void CategoryInfScene::updateCatDisplay() {
    ...
    ImGui::Text("Name: %s", sequence->mStageName.cstr());
    ImGui::Text("Scenario: %u", sequence->mNextScenarioNum);
    ImGui::Text("Entrance: %s", sequence->mGameDataHolderAccessor.mData->getGameDataFile()->getPlayerStartId());
