...
PrimMenuSettings::PrimMenuSettings(DevGuiManager* parent) {
    ...
    mSettings.tryAllocBuffer(0x40, parent->getHeap());
    ...
    registerNewSetting(false, "Player Velocity (XZ)", PrimMenuCat_PLAYER, false);
    registerNewSetting(false, "Player Velocity (XYZ)", PrimMenuCat_PLAYER, false);
