...
#include "custom/game/System/GameFrameWorkNx.h"
...
WindowFPS::WindowFPS(DevGuiManager* parent, const char* winName, bool isActiveByDefault) : WindowBase(parent, winName, isActiveByDefault) {
