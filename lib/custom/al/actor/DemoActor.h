...
public:
    ...
    virtual void initDemoActor(const al::ActorInitInfo&, const al::ActorInitInfo&, const sead::Matrix34f*, bool);
    virtual void initDemoActorSerial(const al::ActorInitInfo&, const al::ActorInitInfo&, const sead::Matrix34f*);
    virtual void initAfterCreateFromFactory(const al::ActorInitInfo&, const al::ActorInitInfo&, const sead::Matrix34f*, bool);
