...
public:
    BalloonMessage(const al::LiveActor*, const al::LayoutInitInfo&, const al::BalloonMessageInitParam&, bool isUseDistance);
...
BalloonMessage* createBalloonMessage(const al::LiveActor*, const al::ActorInitInfo&);
BalloonMessage* createBalloonMessage(const al::LiveActor*, const al::ActorInitInfo&, const char*);
BalloonMessage* createBalloonMessage(const al::LiveActor*, const al::ActorInitInfo&, const al::BalloonMessageInitParam&);
BalloonMessage* createBalloonMessageNoAutoUpdate(const al::LiveActor*, const al::ActorInitInfo&, const al::BalloonMessageInitParam&);
}  // namespace al
