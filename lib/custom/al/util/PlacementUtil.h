...
bool tryGetLinksInfo(al::PlacementInfo*, const al::PlacementInfo&, const char*);
...
al::StringTmp<0x80> makeStringPlacementId(const al::PlacementId*);

void tryGetPlacementInfoAndCount(PlacementInfo*, int*, const StageInfo*, const char*);
