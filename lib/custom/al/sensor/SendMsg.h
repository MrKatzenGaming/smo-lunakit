...
bool sendMsgInitTouchTargetInfo(al::HitSensor*, al::HitSensor*, TouchTargetInfo*, const sead::Vector3<float>*);
...
bool sendMsgGotogotonGoalMatch(al::HitSensor*, al::HitSensor*, const GotogotonMark*);
...
bool sendMsgCheckFishingTarget(al::HitSensor*, al::HitSensor*, const FishingFish*);
...
bool sendMsgInitCapTarget(al::HitSensor*, al::HitSensor*, const CapTargetInfo**);
