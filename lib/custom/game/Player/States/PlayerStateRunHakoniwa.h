...
public:
    PlayerStateRunHakoniwa(al::LiveActor*, const PlayerConst*, const PlayerInput*, const IUsePlayerCollision*, struct PlayerCounterForceRun const*,
                           struct PlayerCounterQuickTurnJump const*, struct PlayerTrigger*, PlayerAnimator*, struct PlayerEffect*,
                           struct PlayerJointParamCenterDynamics*, struct IJudge const*, bool);
    void appear(void);
    void kill(void);
    void control(void);
