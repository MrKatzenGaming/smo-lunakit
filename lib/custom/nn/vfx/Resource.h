...
class Resource {
public:
    // Resource(nn::gfx::TDevice<nn::gfx::ApiVariation<nn::gfx::ApiType<4>,nn::gfx::ApiVersion<8>>> *,nn::vfx::Heap *,void
    // *,nn::gfx::TMemoryPool<nn::gfx::ApiVariation<nn::gfx::ApiType<4>,nn::gfx::ApiVersion<8>>> *,ulong,ulong,int,nn::vfx::System
    // *,bool,nn::vfx::Resource*);	T
    virtual ~Resource();
    ...
    // *,nn::gfx::TTextureView<nn::gfx::ApiVariation<nn::gfx::ApiType<4>,nn::gfx::ApiVersion<8>>> const&,void *),void *);
    ...
    // *,nn::gfx::TTextureView<nn::gfx::ApiVariation<nn::gfx::ApiType<4>,nn::gfx::ApiVersion<8>>> const&,void *),void *); void
    // BindExternalG3dResFile(nn::g3d::ResFile *); void BindExternalResShaderFile(nn::gfx::ResShaderFile *,nn::gfx::ResShaderFile *);
