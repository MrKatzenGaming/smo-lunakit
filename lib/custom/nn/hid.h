...
// void SetSupportedNpadIdType(const uint*, ulong);

// void SetSupportedNpadStyleSet(nn::util::BitFlagSet<32, nn::hid::NpadStyleTag>);

// nn::hid::NpadStyleSet GetNpadStyleSet(const uint& port);

// void GetNpadState(nn::hid::NpadFullKeyState*, const uint& port);

// void GetNpadState(nn::hid::NpadHandheldState*, const uint& port);

// void GetNpadState(nn::hid::NpadJoyDualState*, const uint& port);

// void GetNpadState(nn::hid::NpadJoyLeftState*, const uint& port);

// void GetNpadState(nn::hid::NpadJoyRightState*, const uint& port);

// void GetNpadStates(nn::hid::NpadFullKeyState*, int, const uint& port);

// void GetNpadStates(nn::hid::NpadHandheldState*, int, const uint& port);

// void GetNpadStates(nn::hid::NpadJoyDualState*, int, const uint& port);

// void GetNpadStates(nn::hid::NpadJoyLeftState*, int, const uint& port);

// void GetNpadStates(nn::hid::NpadJoyRightState*, int, const uint& port);

// int ShowControllerSupport(nn::hid::ControllerSupportResultInfo*, const ControllerSupportArg&);
